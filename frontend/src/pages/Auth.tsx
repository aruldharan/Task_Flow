              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-center pt-2">
                  <Button
                    variant="outline"
                    type="button"
                    className="w-full py-6 rounded-full border-primary/20 bg-background hover:bg-primary/5 transition-all duration-300 flex items-center justify-center gap-3 group"
